...
<div style="width:100%; margin-bottom:15px">
  <div class="embed-container">
    <iframe
      src="https://player.vimeo.com/video/576704006?autoplay=1&loop=1&autopause=0"
      frameBorder="0"
      allow="autoplay; fullscreen"
      allowFullScreen
      style="background-color : rgb(247, 245, 242)"
      loading="lazy"
    ></iframe>
  </div>
</div>
...
<div style="width:100%; margin-bottom:15px">
  <div class="embed-container">
    <iframe
      src="https://player.vimeo.com/video/576700785?autoplay=1&loop=1&autopause=0"
      frameBorder="0"
      allow="autoplay; fullscreen"
      allowFullScreen
      style="background-color : rgb(247, 245, 242)"
